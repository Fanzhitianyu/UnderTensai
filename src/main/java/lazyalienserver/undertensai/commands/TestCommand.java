...
//        ParticleManager.ParticleList.add(new Pair<>(ParticleTypes.CLOUD,new Pair<>(pos,pos2)));
        //Objects.requireNonNull(c.getSource().getClient().particleManager).addParticle(ParticleTypes.CLOUD,pos.x,pos.y,pos.z,pos2.x,pos2.y,pos2.z);
        return 0;
    }
}
